...
class MetisApi(object):
    ...
    def init_app(self, app):
        self.__api_url = app.config['METIS_API']
        self.__headers = {
            'x-app-shortname': app.config['METIS_APPNAME']
        }
        self.__headers['Content-Type'] = 'application/json'
        self.__auth = HTTPBasicAuth(app.config['METIS_USER'], app.config['METIS_PWD'])
